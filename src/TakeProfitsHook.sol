...
contract TakeProfitsHook is BaseHook, ERC1155 {
    ...
    function _tryFulfillingOrders(
        ...
        // i.e. if someone does a zeroForOne swap to decrease price of token 0 (thus increase price of Token 1), we execute
        ...
        // Else if tick has decreased (i.e. zeroForOne swaps happened)
        else {
            // Loop through all ticks between the lastTickLower and currentTickLower
